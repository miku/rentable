...
CORNERS = {
    ...
    /* top images*/
    TL : {src:'images/corners/topl.png', sizing: 'scale'},
    TM : {src:'images/corners/topm.png', sizing: 'crop'},
    TR : {src:'images/corners/topr.png', sizing: 'scale'},
    
    /* middle images */
    ML : {src:'images/corners/midl.png', sizing: 'crop'},
    MR : {src:'images/corners/midr.png', sizing: 'crop'},
    
    /* bottom images */
    BL : {src:'images/corners/botl.png', sizing: 'scale'},
    BM : {src:'images/corners/botm.png', sizing: 'crop'},
    BR : {src:'images/corners/botr.png', sizing: 'scale'}
}
